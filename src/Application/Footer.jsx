...
function Footer() {
  ...
  return (
    ...
    <p style={{fontSize: "13px", fontWeight:"700"}}><Link to="#" style={{textDecoration:"none",color:"#000"}}>HOME</Link></p>
    </div>
    ...
    <p style={{fontSize: "13px", fontWeight:"700"}}><Link to="#" style={{textDecoration:"none",color:"#000"}}>Account</Link></p>
    </div>
